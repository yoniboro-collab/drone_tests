...
class TestWaypointMission:
    ...
    def test_mission_upload(self, vehicle_reset):
        ...
        actual = vehicle_reset.commands.count
        assert actual == expected_count, f"Expected {expected_count} commands, got {actual}"
...
with open(r"C:\drone_tests\tests\test_waypoint_mission.py", "w") as f:
    f.write(content)
